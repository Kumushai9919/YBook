...
import com.example.ybook.activities.PdfDetailActivity;
import com.example.ybook.activities.PdfEditActivity;
import com.example.ybook.databinding.RowPdfAdminBinding;
import com.example.ybook.filters.FilterPdfAdmin;
...
//      load further details like category, pdf from url, pdf size in separate functions
        ...
        //handle click, show dialog with options 1) edits, 2) delete
