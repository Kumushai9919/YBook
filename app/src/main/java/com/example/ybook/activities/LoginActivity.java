...
public class LoginActivity extends AppCompatActivity {
    ...
    //view binding
    private com.example.ybook.databinding.ActivityLoginBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.example.ybook.databinding.ActivityLoginBinding.inflate(getLayoutInflater());
    ...
    private void validateData() {
        //before loging, do some data validation
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if(userType.equals("user")){
                            //this is sumple user, open user dashboard
