...
import com.example.ybook.databinding.ActivityProfileEditBinding;
        ...
        databaseReference.child(firebaseAuth.getUid())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(ProfileEditActivity.this, "Failed to update db dur to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
