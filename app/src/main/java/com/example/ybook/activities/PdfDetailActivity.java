...
import com.example.ybook.MyApplication;
import com.example.ybook.R;
import com.example.ybook.adapters.AdapterComment;
import com.example.ybook.adapters.AdapterPdfFavorite;
import com.example.ybook.databinding.ActivityPdfDetailBinding;
import com.example.ybook.databinding.DialogCommentAddBinding;
import com.example.ybook.models.ModelComment;
...
public class PdfDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //at start hide download btn, because we need book url that we will load later in function loadBookDetails();
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //format date
                        String date = MyApplication.formatTimestamp(Long.parseLong(timestamp, 10));
