...
import com.example.ybook.BooksUserFragment;
import com.example.ybook.databinding.ActivityDashboardUserBinding;
...
public class DashboardUserActivity extends AppCompatActivity {
    ...
    private void setupViewPagerAdapter(ViewPager viewPager){
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                //clear before adding to list, (add data to -> 1-models, -> 2-list,-> 3-view pager adapter
                categoryArrayList.clear();

                //Load Categories = (1)Static ex: All, Most viewed, Most Downloaded
                //Add data to
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter{
        ...
        private void addFragment(BooksUserFragment fragment, String title){
            ...
            //add title passed as parameter in fragmentTitleLsit
