...
import com.example.ybook.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    private void validateData(){
        ...
        {
            //if all data validated then update(change) data
            updatePdf();
        }
    ...
    private void updatePdf() {
        ...
        //setup data(hashmap) to update to db
    ...
    private void categoryDialog(){
        //make string array from arraylsit of string
