...
import static com.example.ybook.Constants.MAX_BYTES_PDF;
...
public class MyApplication extends Application {
                        ...
                        reference.child(bookId)
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Log.d(TAG, "onFailure: Failed to delte from db due to "+e.getMessage());
    ...
    public static void downloadBook(Context context, String bookId, String bookTitle, String bookUrl){
        ...
        ProgressDialog progressDialog = new ProgressDialog(context);
        progressDialog.setTitle("Please wait");
        progressDialog.setMessage("Downloading "+ nameWithExtension +"...");//ex: Downloading ABC_Book.pdf
    ...
    private static void saveDownloadedBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        Log.d(TAG_DOWNLOAD, "saveDownloadedBook: Saving dowloaded book");
        try{
